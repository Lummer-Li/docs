...
![SpringBoot核心功能](https://gitee.com/Lummer/image/raw/master/img/20210729140933.png)
...
![image.png](https://gitee.com/Lummer/image/raw/master/img/20210729185817.png)
...
5. 自定义MessageConverter
	...
	0. @ResponseBody响应数据出去调用RequestResponseBodyMethodProcessor处理
...
1. 导入JDBC场景
	...
	![image.png](https://gitee.com/Lummer/image/raw/master/img/20210731180816.png)

	数据库驱动?

	为什么导入JDBC场景, 官方不导入驱动吗? 官方不知道我们要操作什么数据库. 
		    ...
		    druid:
		      ...
		      filter:
		        ...
		        wall:
		          enabled: true
		          config:
		            drop-table-allow: falseSpringBoot配置示例
...
![image.png](https://gitee.com/Lummer/image/raw/master/img/20210731224838.png)
...
1. 配置模式
	...
	- Mapper: 只要我们写的操作MyBatis的接口标准了, @Mapper就会被自动扫描
	...
	配置private Configuration configuration. mybatis.configuration下面的所有, 就是相当于改变mybatis全局配置文件中的值
...
3. 混合模式
	...
	- @MapperScan(“com.atguigu.admin.mapper”)简化, 其他的接口就可以不要标注@Mapper注解
...
1. Redis自动配置
	...
	![image.png](https://gitee.com/Lummer/image/raw/master/img/20210731225913.png)
...
![img](https://gitee.com/Lummer/image/raw/master/img/20210731230148.png)
...
![img](https://gitee.com/Lummer/image/raw/master/img/20210731230154.png)
...
1. 简介
	...
	![img](https://gitee.com/Lummer/image/raw/master/img/20210731231103.png)

2. 1.x与2.x的不同

	![image.png](https://gitee.com/Lummer/image/raw/master/img/20210731231143.png)
...
2. Health Endpoint
	...
	![img](https://gitee.com/Lummer/image/raw/master/img/20210731231349.png)
...
3. Metrics Endpoint
	...
	![img](https://gitee.com/Lummer/image/raw/master/img/20210731231415.png)
...
1. starter启动原理
	...
	![img](https://gitee.com/Lummer/image/raw/master/img/20210731232721.png)
...
1. SpringBoot启动过程
	...
	![img](https://gitee.com/Lummer/image/raw/master/img/20210731232928.png)

	![img](https://gitee.com/Lummer/image/raw/master/img/20210731232932.png)

	![img](https://gitee.com/Lummer/image/raw/master/img/20210731232936.png)
